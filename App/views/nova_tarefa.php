		    ...
		    <div class="container pagina">
			  <div class="row">
			    <div class="col">
		  		  <h4>Nova tarefa</h4>
				  <hr/>
				  <form method="post" action="../controllers/tarefa_controller.php?acao=inserir">
				    <div class="form-group">
					  <label>Descrição da tarefa:</label>
					    <input type="text" class="form-control" name="tarefa" placeholder="Exemplo: Lavar o carro">
					  <br/>
					  <label>Quem deve realizar:</label>
					    <input type="text" class="form-control" name="usuario" placeholder="Exemplo: Fulano de tal">
					  <br/>
					  <label>Categoria</label>
                      <select name="categoria" class="form-control">
                        <option>Dever de casa</option>
